...
Route-and-cluster heuristic for the VRP which uses nearest neighbor algorithm
in the routing phase
"""

import pandas as pd
from TSPalgos import nearest_neighbor as nnh
...
# Construct a TSP tour over all nodes using nearest neighbor algorithm
tour = nnh(nodes, origin, d)[0]
